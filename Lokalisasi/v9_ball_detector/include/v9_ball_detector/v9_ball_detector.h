...
private:
    ...
    ros::Subscriber head_angle_sub_; //derajat kepala baru v12
    ...
    // fungsi buat mengelola data segemented warna 
    // void getPoints(const cv::Mat &segmented_white, const cv::Mat &invert_segmented_green, const cv::Mat &field_boundry, Points &target_points)
    void publishPoints(Points target_points);
